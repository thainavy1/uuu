...
wait = {
    ...
    "unsend":True,
    "selfbot":True,
    "mention":"ɴɢıɴтıᴘ ᴀᴊᴇ ʟu тоиɢ, sıиı мᴀsuк ɢᴀвuиɢ..!!",
    "Respontag":"👉Auto Respon👈 \n🚫ɴɢᴇтᴀɢ ɢuᴇ ʟᴀɢı, ɢuᴇ кuтuк ʟu ĵᴀᴅı sᴇтяıкᴀᴀɴ..!!! 🚫",
    "welcome":"selamat datang di rumah kami, salken semoga betah ya..??😊😊🙏🙏",
    "comment":"Like like & like by ʙᴏᴛs JhaiL",
    "comment1":"Like like & like by ʙᴏᴛs JhaiL of Gamer",
    "message":"тᴇяıмᴀ кᴀsıн suᴅᴀн ᴀᴅᴅ sᴀʏᴀ \nвʏ.ᴛᴇᴀᴍ ʙᴏᴛs JhaiL \nline.me/ti/p/~team_scorpion",
}
protect = {
    "pqr":[],
    "pinv":[],
...
def help():
    ...
    key = key.title()
    helpMessage = "      ⟦▬▬▬▬⟦ஜ۩۞۩ஜ⟧▬▬▬▬⟧\n"
    helpMessage += "╔════۩ই в❍тs✯ً͜͜͡JhàរឺLই۩═══\n"
    ...
    num = (num+1)
    helpMessage += "║☯➸ %i. " % num + key + "Joness\n"
    num = (num+1)
    helpMessage += "║☯➸ %i. " % num + key + "Status\n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage += "║☯➸ %i. " % num + key + "Delete mantan\n"
    num = (num+1)
    helpMessage += "║☯➸ %i. " % num + key + "Anu mu/ku\n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage += "║☯➸ %i. " % num + key + "Setsider: text\n"
    num = (num+1)
    helpMessage += "║☯➸ %i. " % num + key + "Setpesan: text\n"
    num = (num+1)
    helpMessage += "║☯➸ %i. " % num + key + "Setwelcome: text\n"
    num = (num+1)
    helpMessage += "║☯➸ %i. " % num + key + "Setrepson: text\n"
    num = (num+1)
    helpMessage += "║☯➸ %i. " % num + key + "Ceksider\n"
    num = (num+1)
    helpMessage += "║☯➸ %i. " % num + key + "Cekpesan\n"
    num = (num+1)
    ...
    helpMessage += "╚══════════════"
    helpMessage += " Creator: https://line.me/ti/p/~agoest_jhail \n"
    return helpMessage
...
def helpbot():
    ...
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Jhailin \n"
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Bl \n"
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Jos \n"
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Geboy \n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage2 += "║☯➸v %i. " % num + key + "Admin:on\n"
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Adminadd @\n"
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Adminexpl:on @\n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Hobah [ kickall ]\n"
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Crooot [ kickall ]\n"
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Sleep \n"
    num = (num+1)
    ...
    helpMessage2 += "║" + "─⍟ᴛᴇᴀᴍ ʙᴏᴛ ᴘʀᴏᴛᴇᴄᴛ⍟─\n"
    helpMessage2 += "╚══════════════"
    helpMessage2 += " My ID LINE : https://line.me/ti/p/~agoest_jhail \n"
    return helpMessage2
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                ki.createGroup("room TES BOT ",[target]) # KALAU MAU BUAT BANYAK SILAHKAN TAMBAHIN SESUKA KALIAN :>
                                ki.createGroup("room TES BOT ",[target]) # HANYA SPAM VIA CONTACT                                
                        ...
                        if cmd == "on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin or msg._from in staff:                                               
                               ...
                               cl.sendMessage(msg.to, "On bos siap di Hooobah")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                               ...
                               if key in [""," ","\n",None]:
                                   cl.sendMessage(msg.to, "Succes change name")
                               else:
                                   Setmain["keyCommand"] = str(key).lower()
                                   cl.sendMessage(msg.to, "🔴Sname change \n\nname succes change to {}".format(str(key).lower()))

                        elif text.lower() == "resetname":
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                               Setmain["keyCommand"] = ""
                               cl.sendMessage(msg.to, "Succes Reset name ")
...
#===========BOT UPDATE============#
                        elif cmd == "mentil" or text.lower() == 'ups':
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin or msg._from in staff:
                         ...
                         if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ki.sendMessage(msg.to, "۞❂✪BLACK ₭ιll₠₹ ⋮➲➤➤")
                               kk.sendMessage(msg.to, "۞❂✪BLACK ₭ιll₠₹ ⋮➲➤➤")
                               kc.sendMessage(msg.to, "۞❂✪BLACK₭ιll₠₹ ⋮➲➤➤")
                               km.sendMessage(msg.to, "۞❂✪BLACK ₭ιll₠₹ ⋮➲➤➤")
                               kb.sendMessage(msg.to, "۞❂✪BLACK ₭ιll₠₹ ⋮➲➤➤")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                               start = time.time()                               
                               cl.sendMessage(msg.to, "Prosess menghitung kutang....\nplease wait....")                               
                           ...
                           if msg._from in owner or msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protect["pinv"]:
                                       msgs = "Proinvite has been active"
                                  else:
                                  ...
                                  cl.sendMessage(msg.to, "Activated \n\n" + msgs)
                                    ...
                                    if msg.to in protect["pinv"]:
                                         ...
                                         ginfo = cl.getGroup(msg.to)
                                         msgs = "Proinvite deactive\nIn group : " +str(ginfo.name)
                                    else:
                                         msgs = "Proinvite has been disable"
                                    cl.sendMessage(msg.to, "Nonactive\n\n" + msgs)
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                             if msg.toType == 2:
                                 ...
                                 cl.sendMessage(msg.to,"「 Sorry r̸o̸o̸m̸ n̸y̸a̸ k̸a̸m̸i̸ s̸i̸t̸a̸ s̸e̸e̸ y̸o̸u̸ s̸l̸a̸m̸ d̸a̸r̸i̸ TΣΔM JHAIL βΩT」")
                                 targets = []
                                 for g in gs.members:
                                     if _name in g.displayName:
                                         targets.append(g.mid)
                                 if targets == []:
                                     cl.sendMessage(msg.to,"Limit bos")
                                 else:
                                     for target in targets:
...
#==================================#
                            ...
                            if msg._from in owner or msg._from in admin or msg._from in staff:
                                ...
                                cl.sendMessage(msg.to,"Mandi dan gosok  gigi done 💯\n mau pakek baju dulu....")
